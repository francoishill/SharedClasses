...
public class NsisInterop
{
		...
		bool HasPlugins)
	{
		...
		SectionGroupLines.Add(@"	  NSISdl::download ""http://apps.getmyip.com/ownapplications/shownocallbacknotification/ShowNoCallbackNotification_SetupLatest.exe"" tmpShowNoCallbackNotification_SetupLatest.exe ; Download latest ShowNoCallbackNotification Setup");
		SectionGroupLines.Add(@"	  Pop $R4 ;Read the result of the download");
