...
{
	public class WpfDraggableCanvas : Canvas
	{
		#region Data
		...
		static WpfDraggableCanvas()
		{
			AllowDraggingProperty = DependencyProperty.Register(
					"AllowDragging",
					typeof(bool),
					typeof(WpfDraggableCanvas),
		...
		public UIElement ElementBeingDragged
		{
			...
			protected set
			{
				...
				{
					if (WpfDraggableCanvas.GetCanBeDragged(value))
					{
